...
import { updateHouseholdNameAction, updateAiConfigAction, clearAiConfigAction } from "@/actions/household";
...
export function AiConfigForm({
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-muted">
        Your key is stored only in your household&apos;s database and never sent to the browser. It is used solely to call the AI provider on your behalf when you use the assistant.
      </p>
    </div>
  );
}
