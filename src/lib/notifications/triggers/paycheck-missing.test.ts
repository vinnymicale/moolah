...
const ctx = (over: Partial<TriggerContext> = {}): TriggerContext => ({
  userId: "u1", householdId: "h1", params: { graceDays: 3 }, todayISO: "2026-07-09",
...
describe("paycheck-missing", () => {
  const rule = {
    id: "r1", description: "Paycheck",
    versions: [{
      effectiveFrom: new Date("2026-01-01"), type: "INCOME", frequency: "MONTHLY", interval: 1,
